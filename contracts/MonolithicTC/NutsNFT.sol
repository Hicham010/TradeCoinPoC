...
contract NutsNFT is ERC721 {
    ...
    mapping(uint256 => string) public nut_type;
    ...
    function mintNut(uint256 _weight_gram, string memory _nut_type) public {
    ...
    function batchNuts(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            keccak256(abi.encode(nut_type[_tokenId1])) ==
                keccak256(abi.encode(nut_type[_tokenId2])),
